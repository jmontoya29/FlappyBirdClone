...
//  FlappyBirdClone
//
//  Created by Jeison Montoya on 2/12/16.
//  Copyright (c) 2016 Montoya Group. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView)
    {
        ...
        _ = NSTimer.scheduledTimerWithTimeInterval(2, target: self, selector: "makePipes", userInfo: nil, repeats: true)
    ...
    func makePipes()
    {
        ...
        gap.physicsBody!.contactTestBitMask = ColliderType.Object.rawValue
